...
public class GestaoAcademicaApp1 {
    ...
    public static void listarEstudantes(Faculdade faculdade){
        ...
        for(Estudante estudante : estudantes){
            ...
            System.out.println("[" + indiceEstudante + "] " + "Número: " + 
                    estudante.getId() + ", Nome: " + estudante.getNome()); 
    ...
    public static void listarEstudantesMatriculados(Faculdade faculdade, String codigoDisciplina){
        ...
        for(Matricula matricula : matriculas){
            ...
            //Imprimi no console ás informações de cada estudante.
            System.out.println("[" + indiceMatricula + "] " + "Número: " + estudante.getId() 
                    + ", Nome: " + estudante.getNome() + ", E-mail: " + estudante.getEmail());
    ...
    public static void listarDisciplinasMatriculadas(Faculdade faculdade, long codigoEstudante){        
        ...
        //Armazenará o total de crédito do estudante.
        int totalCreditos = 0;
